...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_MULTIPLE = 39,                  /* MULTIPLE  */
  YYSYMBOL_DIVIDE = 40,                    /* DIVIDE  */
  YYSYMBOL_MOD = 41,                       /* MOD  */
  YYSYMBOL_LESSTHAN = 42,                  /* LESSTHAN  */
  YYSYMBOL_GREATERTHAN = 43,               /* GREATERTHAN  */
  YYSYMBOL_NL = 44,                        /* NL  */
  YYSYMBOL_INCREASE = 45,                  /* INCREASE  */
  YYSYMBOL_DECREASE = 46,                  /* DECREASE  */
  YYSYMBOL_COLON = 47,                     /* COLON  */
  YYSYMBOL_SEMICOLON = 48,                 /* SEMICOLON  */
  YYSYMBOL_COMMA = 49,                     /* COMMA  */
  YYSYMBOL_EQUALORGREAT = 50,              /* EQUALORGREAT  */
  YYSYMBOL_EQUALORLESS = 51,               /* EQUALORLESS  */
  YYSYMBOL_EQUAL = 52,                     /* EQUAL  */
  YYSYMBOL_ISNOTEQUAL = 53,                /* ISNOTEQUAL  */
  YYSYMBOL_LOGICAL_AND_OPERATOR = 54,      /* LOGICAL_AND_OPERATOR  */
  YYSYMBOL_OR = 55,                        /* OR  */
  YYSYMBOL_LEFT_PARENTHESIS = 56,          /* LEFT_PARENTHESIS  */
  YYSYMBOL_RIGHT_PARENTHESIS = 57,         /* RIGHT_PARENTHESIS  */
  YYSYMBOL_LEFT_BRACE = 58,                /* LEFT_BRACE  */
  YYSYMBOL_RIGHT_BRACE = 59,               /* RIGHT_BRACE  */
  YYSYMBOL_LEFTSQRBR = 60,                 /* LEFTSQRBR  */
  YYSYMBOL_RIGHTSQRBR = 61,                /* RIGHTSQRBR  */
  YYSYMBOL_QUOTES = 62,                    /* QUOTES  */
  YYSYMBOL_IFX = 63,                       /* IFX  */
...
static const char *const yytname[] =
{
  ...
  "END_FUNCTION", "RETURN", "ELSE", "DO", "FOR", "END_FOR", "TRY", "CATCH",
  "THEN", "SWITCH", "CASE", "IMPORT", "BREAK", "CONTINUE", "ASSIGN",
  "SCAN", "POW", "PLUS", "MINUS", "MULTIPLE", "DIVIDE", "MOD", "LESSTHAN",
  "GREATERTHAN", "NL", "INCREASE", "DECREASE", "COLON", "SEMICOLON",
  "COMMA", "EQUALORGREAT", "EQUALORLESS", "EQUAL", "ISNOTEQUAL",
  "LOGICAL_AND_OPERATOR", "OR", "LEFT_PARENTHESIS", "RIGHT_PARENTHESIS",
  "LEFT_BRACE", "RIGHT_BRACE", "LEFTSQRBR", "RIGHTSQRBR", "QUOTES", "IFX",
  "UMINUS", "$accept", "program", "function", "stmt", "stmt_list",
  "Comment", "expr", YY_NULLPTR
};
...
{
     -39,    14,    16,   -39,   -39,   -17,   -38,   -24,    12,   -39,
     -39,    12,   -39,    12,    16,   -39,    16,   102,    12,    12,
      12,   -39,   119,   -39,    -9,   -39,     2,    16,    12,    12,
      12,    12,    12,    12,   -39,    12,    12,    12,    12,   136,
      60,    81,   -39,   -39,   -39,   -39,   -29,   -29,   -39,   -39,
     -36,   -36,   153,   153,    42,    42,   -39,    16,    16,   -39,
      13,    16,   -39
};
...
{
       4,     0,     2,     1,    18,    19,     0,     0,     0,    16,
      17,     0,     5,     0,     0,     3,     0,     0,     0,     0,
       0,    19,     0,    20,     0,    14,     0,    13,     0,     0,
       0,     0,     0,     0,     6,     0,     0,     0,     0,     0,
       0,     0,     7,    31,    12,    15,    21,    22,    23,    24,
      25,    26,    27,    28,    30,    29,     8,     0,     0,     9,
      10,     0,    11
};
...
{
      15,    28,    29,    30,    31,     4,     5,     6,     7,     8,
      30,    31,     9,    10,     3,     4,    21,    18,    19,     4,
       5,     6,     7,     8,    45,    45,     9,    10,    28,    29,
      30,    31,    20,    32,    33,    61,    27,     0,     0,     0,
      11,    35,    36,    37,    38,     0,     0,     0,    43,    12,
      11,     0,     0,     0,    11,    59,    60,     0,    13,    62,
      14,    44,     0,    12,     0,     0,    22,     0,    13,    23,
       0,    24,    13,     0,    14,     0,    39,    40,    41,    28,
      29,    30,    31,     0,    32,    33,    46,    47,    48,    49,
      50,    51,     0,    52,    53,    54,    55,    28,    29,    30,
      31,     0,    32,    33,     0,     0,     0,     0,     0,     0,
      35,    36,    37,    38,     0,     0,     0,    57,    28,    29,
      30,    31,     0,    32,    33,     0,     0,     0,     0,     0,
       0,    35,    36,    37,    38,     0,     0,     0,    58,    28,
      29,    30,    31,     0,    32,    33,     0,     0,     0,    34,
       0,     0,    35,    36,    37,    38,    28,    29,    30,    31,
       0,    32,    33,     0,     0,     0,    42,     0,     0,    35,
      36,    37,    38,    28,    29,    30,    31,     0,    32,    33,
       0,     0,     0,    56,     0,     0,    35,    36,    37,    38,
...
{
       2,    37,    38,    39,    40,     3,     4,     5,     6,     7,
      39,    40,    10,    11,     0,     3,     4,    34,    56,     3,
       4,     5,     6,     7,    26,    27,    10,    11,    37,    38,
      39,    40,    56,    42,    43,    22,    16,    -1,    -1,    -1,
      38,    50,    51,    52,    53,    -1,    -1,    -1,    57,    47,
      38,    -1,    -1,    -1,    38,    57,    58,    -1,    56,    61,
      58,    59,    -1,    47,    -1,    -1,     8,    -1,    56,    11,
      -1,    13,    56,    -1,    58,    -1,    18,    19,    20,    37,
      38,    39,    40,    -1,    42,    43,    28,    29,    30,    31,
      32,    33,    -1,    35,    36,    37,    38,    37,    38,    39,
      40,    -1,    42,    43,    -1,    -1,    -1,    -1,    -1,    -1,
      50,    51,    52,    53,    -1,    -1,    -1,    57,    37,    38,
      39,    40,    -1,    42,    43,    -1,    -1,    -1,    -1,    -1,
      -1,    50,    51,    52,    53,    -1,    -1,    -1,    57,    37,
      38,    39,    40,    -1,    42,    43,    -1,    -1,    -1,    47,
      -1,    -1,    50,    51,    52,    53,    37,    38,    39,    40,
      -1,    42,    43,    -1,    -1,    -1,    47,    -1,    -1,    50,
      51,    52,    53,    37,    38,    39,    40,    -1,    42,    43,
...
{
       0,    66,    67,     0,     3,     4,     5,     6,     7,    10,
      11,    38,    47,    56,    58,    68,    70,    71,    34,    56,
      56,     4,    71,    71,    71,    68,    69,    69,    37,    38,
      39,    40,    42,    43,    47,    50,    51,    52,    53,    71,
      71,    71,    47,    57,    59,    68,    71,    71,    71,    71,
      71,    71,    71,    71,    71,    71,    47,    57,    57,    68,
      68,    22,    68
};
...
#line 1497 "y.tab.c"
  ...
  case 23: /* expr: expr MULTIPLE expr  */
#line 85 "eon.y"
...
#line 1545 "y.tab.c"
  ...
  case 31: /* expr: LEFT_PARENTHESIS expr RIGHT_PARENTHESIS  */
#line 93 "eon.y"
                                                           { (yyval.nPtr) = (yyvsp[-1].nPtr); }
#line 1551 "y.tab.c"
    break;
